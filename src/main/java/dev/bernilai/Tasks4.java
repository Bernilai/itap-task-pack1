...
public class Tasks4 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("String without repeats: " + nonRepeat("abracadabra"));
        System.out.println("Brute force when k <= n: " + bruteForce(1, 5));
        System.out.println("Brute force when k > n: " + bruteForce(5, 3));
        System.out.println("Encoded string: " + encode(List.of(0, 31, 28, 10, 29), "MKIIT"));
        System.out.println("Decoded string: " + decode("MTUCI", "MKIIT"));
        System.out.println("Parenthesis cluster: " + split("((()))(())()()(()())"));
        System.out.println("Shortened string: " + shortHand("vvvvaajaaaaa"));
        System.out.println("Converted to Roman numerals: " + convertToRome(1234));
        System.out.println("Unique indices parity: " + uniqueSubstring("31312131"));
        System.out.println("Passable labyrinth: " + labyrinth(matrix1));
        System.out.println("Impassable labyrinth: " + labyrinth(matrix2));
        System.out.println("Ordered string: " + numericOrder("t3o the5m 1One all6 r4ule ri2ng"));
        System.out.println("Is Fibonacci sequence: " + fibString("CCCABDD"));
    ...
    public static String uniqueSubstring(String s) {
        ...
        return (maxIndex[0] % 2 == 0) ? "even" : "odd";
    }
    ...
    public static List<String> labyrinth(int[][] matrix) {
        ...
        if (matrix[n - 1][n - 1] < 0 || matrix[0][0] < 0) {
            return Collections.singletonList("Dead end");
        }
